          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="form-group pull-right">
                      <a href="<?php echo U('Manager/rolehandle');?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>新增角色</a>
                    </div>            
               </div>     
               <!-- /.box-header -->
               <div class="box-body">              
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row">
                         ...
                         <td>
                         <a class="btn btn-primary" href="<?php echo U('Manager/rolehandle',array('role_id'=>$vo['role_id']));?>"><i class="fa fa-pencil"></i></a>
                          <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Manager/rolehandle');?>" data-id="<?php echo ($vo["id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>      
                </td>
