  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg"></p>
          ...
          <?php if(!empty($isShowCode)): ?><div class="form-group has-feedback">
            <opinioncontrol realtime="true" opinion_name="vertify_code" default="true">
                <div class="row" style="padding-right: 65px;">
                    ...
                    <div class="col-xs-4">
                        <img id="imgVerify" style="cursor:pointer;" src="<?php echo U('Public/vertify');?>" onclick="fleshVerify();"/>
                    </div>
                </div>
            </opinioncontrol>
          </div><?php endif; ?>
        ...
        <div class="margin text-center">
            <div class="copyright">
                2017-<?php echo date('Y');?> &copy; <a href="">foa</a>
                出品
            </div>
        </div>
    </div><!-- /.login-box -->
    ...
    <script>
      ...
      function fleshVerify(){
          //重载验证码
          $('#imgVerify').attr('src','/index.php?m=Home&c=Public&a=vertify&r='+Math.floor(Math.random()*100));
      }
      ...
      function checkLogin(){
          ...
          $.ajax({
            url:'/index.php?m=Home&c=Public&a=login&t='+Math.random(),
            type:'post',
            dataType:'json',
