                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <form action="<?php echo U('Mail/config');?>" method="post" class="form-horizontal" id="mailform">
                            <div class="box-body">                         
                                    <div class="form-group">
                                        <label class="control-label col-sm-2">邮件发送服务器(SMTP)</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" style="width:200px" name="smtp_server" value="<?php echo ($info["smtp_server"]); ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" style="width:200px" name="smtp_port" value="<?php echo ($info["smtp_port"]); ?>">
                                        </div>
                                        <div class="col-sm-4"><span class="help-inline text-warning"></span></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" style="width:200px" name="smtp_user" value="<?php echo ($info["smtp_user"]); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" style="width:200px" name="smtp_pwd" value="<?php echo ($info["smtp_pwd"]); ?>">
                                        </div>
                                        <div class="col-sm-4"><span class="help-inline text-warning"></span></div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
            <?php if($info['status']==0): ?><input type="button" value="测试发送" class="btn btn-info" onclick="sendmail()">
            <?php else: ?>
            <input type="button" value="邮箱验证已通过" class="btn btn-info"><?php endif; ?>
                                        </div>
                                        <div class="col-sm-4"><span class="help-inline text-warning"></span></div>
                                    </div>
