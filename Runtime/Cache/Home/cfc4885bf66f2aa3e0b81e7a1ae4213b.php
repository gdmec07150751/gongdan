          ...
          <div class="col-xs-12">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row">
                         ...
                         <td><a href="javascript:;" onclick="showall('<?php echo ($vo["content"]); ?>','工作内容')"><?php echo (getsubstr($vo["content"],0,10)); ?></a></td>
                         <td><a href="javascript:;" onclick="showall('<?php echo ($vo["plan"]); ?>','工作计划')"><?php echo (getsubstr($vo["plan"],0,10)); ?></a></td>
                         <td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
                         <td>
                          <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('Work/ajaxhandlework');?>" data-id="<?php echo ($vo["id"]); ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
